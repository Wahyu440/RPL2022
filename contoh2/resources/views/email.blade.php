...
*/
        @media(max-width: 619px) {
            ...
            .email-flexible-footer .left-aligned-footer .flexible-footer_share-button_container,
            .email-flexible-footer .center-aligned-footer .flexible-footer_share-button_container,
            .email-flexible-footer .right-aligned-footer .flexible-footer_share-button_container {
                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header"><img
                                        ...
                                        src="public\img\logo.png" alt="" width="141" /></div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                        </div>
                    </div>
                    <div>
                        <div class="layout one-col fixed-width stack"
                            ...
                            <div class="layout__inner"
                                ...
                                <div class="column"
                                    style="text-align: left;color: #595959;font-size: 14px;line-height: 21px;font-family: Lato,Tahoma,sans-serif;">
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-24"
                                                ...
                                                lang="x-size-24"><span
                                                    style="text-decoration: inherit;color: #8690a8;">Transaksi tiket
                                                    Anda telah selesai</span></h1>
                                            <p class="size-17"
                                                style="Margin-top: 20px;Margin-bottom: 20px;font-size: 17px;line-height: 26px;"
                                                lang="x-size-17">Pesanan telah
                                                terverifikasi. Anda dapat melihat bukti pembayaran di attachment e-mail
                                                ini.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                        <div
                                            ...
                                            <p class="size-17"
                                                ...
                                                lang="x-size-17">Terima Kasih telah memesan di BussLightyear</p>
                                            <p class="size-17"
                                                style="Margin-top: 20px;Margin-bottom: 0;font-size: 17px;line-height: 26px;"
                                                lang="x-size-17">Hormat Kami,<br />
                                                <strong>BussLightyear</strong>
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div role="contentinfo">
                        ...
                        <div class="layout email-flexible-footer email-footer"
                            ...
                            <div class="layout__inner right-aligned-footer"
                                ...
                                <div class="column"
                                    style="text-align: right;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;"
                                    dir="ltr">
                                    <div class="footer-logo emb-logo-margin-box"
                                        ...
                                        <div style="margin-left: 20px;" emb-flexible-footer-logo align="center"><img
                                                style="border: 0;display: block;height: auto;width: 100%;max-width: 141px;"
                                                src="public\img\logo.png" alt="" width="141" /></div>
                                    </div>
                                </div>
                                <!--[if (mso)|(IE)]></td><![endif]-->
                                ...
                                <div class="column"
                                    style="text-align: right;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;display: none;"
                                    dir="ltr">
                                ...
                                <table
                                    style="border-collapse: collapse;table-layout: fixed;display: inline-block;width: 439px;"
                                    cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="column js-footer-additional-info"
                                                    style="text-align: right;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Lato,Tahoma,sans-serif;width: 439px;"
                                                    dir="ltr">
                                                    <div
                                                        ...
                                                        <div class="email-footer__additional-info"
                                                            ...
                                                            <div bind-to="address">
                                                                <p class="email-flexible-footer__additionalinfo--center"
                                                                    style="Margin-top: 0;Margin-bottom: 0;">BussLightyear
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="email-footer__additional-info"
                                                            ...
                                                            <div>
                                                                <p class="email-flexible-footer__additionalinfo--center"
                                                                    style="Margin-top: 0;Margin-bottom: 0;">BussLightyear.com
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="email-footer__additional-info"
                                                            ...
                                                            <div bind-to="permission">
                                                                <p class="email-flexible-footer__additionalinfo--center"
                                                                    style="Margin-top: 0;Margin-bottom: 0;">E-Mail ini menjadi bukti sekaligus tiket saat akan naik bus</p>
                                                            </div>
                                                        </div>
                                                        <div class="email-footer__additional-info"
                                                            style="font-size: 12px;line-height: 19px;margin-bottom: 15px;">
