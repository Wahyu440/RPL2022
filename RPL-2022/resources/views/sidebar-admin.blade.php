        ...
        <nav id="sidebar" class="">
			...
			<!-- <div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2><span class="min-dtn">BussLighyear</span></h2>
				</div>
			</div> -->
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Bar Charts" href="bar-charts.html"><span class="mini-sub-pro">Personal</span></a></li>
                                <li><a title="Line Charts" href="line-charts.html"><span class="mini-sub-pro">Institution</span></a></li>
                            </ul>
                        </li>
                        <li>
